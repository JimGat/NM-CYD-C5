...
NM-CYD-C5是基于 ESP32-C5 的 CYD（Cheap Yellow Display），支持双频 Wi-Fi 6 / BLE 5 / Thread / Zigbee。

这款开发板搭载 ESP32-C5，内置 320 x 240 2.8 英寸 LCD 触摸屏，类似于 [ESP32-Cheap-Yellow-Display](https://github.com/witnessmenow/ESP32-Cheap-Yellow-Display)，默认 LCD 驱动为 ST7789，也可以更换为 ILI9341 驱动。
...
- 电阻触摸屏
- ESP32-C5 USB Type-C 接口 和 USB Type-C 转 UART 接口（CH340），用于供电和编程
...
- 双频 Wi-Fi 6：2.4GHz 和 5GHz（802.11n/ac）
...
| **无线协议** | Wi-Fi 6（802.11az）2.4/5GHz + BLE 5.3 + IEEE 802.15.4 |
| **显示屏** | 2.8 英寸 TFT，240*320，ST7789，触摸屏 |
| **存储** | 16MB Flash + 8MB PSRAM |
| **接口** | 2x USB-C、GPIO、Micro SD 卡槽 |
...
如果你期望将你开发的固件或项目在 NM-CYD-C5 上运行，请联系 RockBase IoT 团队，我们将协助你进行适配和测试。

对于你产出的固件，希望在我们的Web Flasher上提供下载，可以关注项目[ESPWebApps](https://github.com/RockBase-iot/ESPWebApps)， 该项目是一个基于 ESP32 的 Web 应用程序管理平台，允许用户在 ESP32 上运行和管理多个 Web 应用程序。通过 ESPWebApps，你可以轻松的将项目与NM-CYD-C5的用户进行共享，可以轻松地下载、安装和更新应用程序，并在 NM-CYD-C5 上运行。
